...
<head>
    <meta charset="UTF-8">
    <title>Welcome to Sistema de Peliculas!</title>
    ...
    <header>
        ...
        <div class="menu">
            <ul>
                ...
                <li class="menu-item hidden"><a href="http://localhost/examen/index.php/usuarios">Usuarios</a></li>
                <li class="menu-item hidden"><a href="http://localhost/examen/index.php/peliculas" target="_blank">Peliculas</a>
                </li>
                <li class="menu-item hidden"><a href="http://localhost/examen/index.php/metricas/ordenes" target="_blank">Reporteria</a></li>
            </ul>
        </div>
        <div class="heroe">
            <h1>Sistema de Administracion de Peliculas</h1>
        </div>
    </header>
